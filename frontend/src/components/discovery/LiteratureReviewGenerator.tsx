...
const LiteratureReviewGenerator: React.FC<LiteratureReviewGeneratorProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg max-w-6xl mx-auto h-[90vh] flex flex-col">
      {/* Header */}
        ...
        {!generatedReview ? (
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Max Sections</label>
                <select
                  value={maxSections}
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="w-full px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-gray-400 flex items-center justify-center space-x-2"
                >
                  {isGenerating ? (
                    <>
                ...
                {availablePapers.length === 0 ? (
                  ...
                  <div className="divide-y divide-gray-200">
                    {availablePapers.map(paper => (
                      <label key={paper.id} className="flex items-start p-3 hover:bg-gray-50 cursor-pointer">
                        <input
                          type="checkbox"
            ...
            <div className="flex items-center space-x-2">
              <div className="flex bg-gray-100 rounded-lg p-1">
                <button
                  ...
                  className={`px-3 py-1 text-sm rounded ${viewMode === 'preview' ? 'bg-white shadow-sm' : 'text-gray-600'}`}
                >
                ...
                <button
                  ...
                  className={`px-3 py-1 text-sm rounded ${viewMode === 'edit' ? 'bg-white shadow-sm' : 'text-gray-600'}`}
                >
              ...
              <button
                ...
                className="px-3 py-2 bg-blue-100 text-blue-800 rounded-lg hover:bg-blue-200 flex items-center space-x-1"
              >
                <Download size={14} />
                <span>Download</span>
              </button>
              {onSave && (
                <button
                  ...
                  className="px-3 py-2 bg-green-100 text-green-800 rounded-lg hover:bg-green-200 flex items-center space-x-1"
                >
                  <Save size={14} />
                  <span>Save</span>
                </button>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-3 flex items-center justify-between">
                Abstract
                <button
            ...
            {editedReview?.research_gaps && editedReview.research_gaps.length > 0 && (
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 mb-3">Research Gaps</h2>
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  <ul className="list-disc list-inside space-y-2">
                    {editedReview.research_gaps.map((gap, index) => (
                      <li key={index} className="text-red-800">{gap}</li>
                    ))}
                  </ul>
                </div>
              </section>
            ...
            {editedReview?.future_directions && editedReview.future_directions.length > 0 && (
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 mb-3">Future Directions</h2>
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <ul className="list-disc list-inside space-y-2">
                    {editedReview.future_directions.map((direction, index) => (
                      <li key={index} className="text-green-800">{direction}</li>
                    ))}
                  </ul>
                </div>
              </section>
