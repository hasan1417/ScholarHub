...
const LiteratureReviewGenerator: React.FC<LiteratureReviewGeneratorProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg max-w-6xl mx-auto h-[90vh] flex flex-col">
      {/* Header */}
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-700 text-gray-900 dark:text-slate-100 placeholder-gray-400 dark:placeholder-slate-500 focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-700 text-gray-900 dark:text-slate-100"
                >
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="w-full px-4 py-2 bg-green-600 text-white rounded-xl hover:bg-green-700 disabled:bg-gray-400 dark:disabled:bg-slate-600 flex items-center justify-center space-x-2"
                >
                  {isGenerating ? (
                    <>
            ...
            <div>
              ...
              <div className="border border-gray-300 dark:border-slate-600 rounded-xl max-h-64 overflow-y-auto">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className="px-3 py-2 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-300 rounded-xl hover:bg-indigo-200 dark:hover:bg-indigo-900/50 flex items-center space-x-1"
              >
                <Download size={14} />
                <span>Download</span>
              </button>
              {onSave && (
                <button
                  ...
                  className="px-3 py-2 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 rounded-xl hover:bg-green-200 dark:hover:bg-green-900/50 flex items-center space-x-1"
                >
                  <Save size={14} />
                  <span>Save</span>
                </button>
      ...
      {isGenerating ? (
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center max-w-md">
            <Clock className="animate-spin h-12 w-12 text-indigo-600 dark:text-indigo-400 mx-auto mb-4" />
          ...
          <div className="prose max-w-none dark:prose-invert">
            ...
            <section className="mb-8">
              ...
              {viewMode === 'edit' ? (
                <textarea
                  ...
                  className="w-full p-3 border border-gray-300 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-700 text-gray-900 dark:text-slate-100"
                  rows={4}
                />
              ) : (
                <p className="text-gray-700 dark:text-slate-300 bg-gray-50 dark:bg-slate-700/50 p-4 rounded-xl">
            ...
            <section className="mb-8">
              ...
              {viewMode === 'edit' ? (
                ...
                <div className="text-gray-700 dark:text-slate-300 whitespace-pre-line bg-gray-50 dark:bg-slate-700/50 p-4 rounded-xl">
                ...
                {section.themes.length > 0 && (
                  <div className="mt-2 flex flex-wrap gap-1">
                    {section.themes.map((theme, idx) => (
                      <span key={idx} className="px-2 py-1 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-300 text-xs rounded-full">
                        {theme}
                      </span>
                    ))}
                  </div>
