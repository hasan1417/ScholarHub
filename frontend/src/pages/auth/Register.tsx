    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50 px-4 py-10 sm:px-6 lg:px-8 sm:py-16 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800">
      <div className="max-w-md w-full space-y-6 sm:space-y-8">
        <div className="bg-white/95 backdrop-blur rounded-2xl border border-gray-200/70 shadow-lg shadow-indigo-100/50 p-6 sm:p-8 dark:bg-slate-800/95 dark:border-slate-700/70 dark:shadow-slate-900/50">
          ...
          <h1 className="mt-6 text-center text-2xl font-semibold text-gray-900 dark:text-slate-100">Create your account</h1>
          ...
          <form className="mt-6 space-y-5" onSubmit={handleSubmit} noValidate>
            <div className="grid gap-4 sm:grid-cols-2 sm:gap-3">
              <div>
                ...
                />
                {formErrors.firstName && (
                  <p id="firstName-error" className="mt-1 text-xs text-red-600 dark:text-red-200">
                    {formErrors.firstName}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {formErrors.lastName && (
                  <p id="lastName-error" className="mt-1 text-xs text-red-600 dark:text-red-200">
                    {formErrors.lastName}
                  </p>
                )}
              </div>
            ...
            <div>
              ...
              />
              {formErrors.confirmPassword && (
                <p id="confirmPassword-error" className="mt-1 text-xs text-red-600 dark:text-red-200">
                  {formErrors.confirmPassword}
                </p>
              )}
            </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-600 dark:text-slate-400">
            ...
            <Link to="/login" className="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-300 dark:hover:text-indigo-200">
              Sign in
            </Link>
          </div>
        </div>
