    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-md px-4 py-10 sm:px-6">
        ...
        <div className="relative">
          ...
          <div className="relative bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl border border-gray-200/50 dark:border-slate-700/50 shadow-2xl shadow-gray-200/50 dark:shadow-slate-900/50 p-8 text-center">
            {renderContent()}
          </div>
        </div>
