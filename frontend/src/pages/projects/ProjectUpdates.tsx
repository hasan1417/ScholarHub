...
const ProjectUpdates = () => {
  ...
  const renderNotificationCard = ({
    ...
    return (
      <li key={key} className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
      ...
      return renderNotificationCard({
        ...
        content: (
          <div className="rounded-lg border border-gray-100 bg-gray-50 p-3 text-sm text-gray-700">
            ...
            <p className="mt-1 text-sm text-gray-700">Status: {toSentence(status ?? action)}.</p>
          </div>
        ),
      })
    }
      ...
      return renderNotificationCard({
        ...
        content: (
          <div className="rounded-lg border border-gray-100 bg-gray-50 p-3 text-sm text-gray-700">
            ...
            <p className="mt-1 text-sm text-gray-700">{projectTitle}</p>
          </div>
        ),
      })
    }
        ...
        content: (
          <div className="space-y-3">
            <div className="rounded-lg border border-gray-100 bg-gray-50 p-3">
              ...
              <p className="mt-1 text-sm text-gray-700">{referenceTitle}</p>
            </div>
            {paperTitle && (
              <div className="rounded-lg border border-indigo-100 bg-indigo-50 p-3 text-sm text-indigo-700">
                ...
                <p className="mt-1 text-sm">{paperTitle}</p>
              </div>
            )}
          </div>
        ),
    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-base font-semibold text-gray-900">Updates & activity</h2>
        </div>
        <span className="text-xs text-gray-400">Project feed for {project.title}</span>
      </div>
