        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div className="space-y-6 lg:col-span-2">
            <section className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm transition-colors dark:border-slate-700 dark:bg-slate-800/60">
              <h2 className="mb-3 text-lg font-semibold text-gray-900 dark:text-slate-100">Overview</h2>
              {isEditing ? (
                <textarea
                  ...
                  placeholder="Tell collaborators what this paper is about..."
                />
              ) : (
                <p className="text-gray-600 dark:text-slate-300">
                  {paper.abstract || 'No abstract provided yet.'}
                </p>
              )}
            </section>
